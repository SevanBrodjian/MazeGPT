...
while(True):
    ...
    messages=[
            {"role": "user", "content": start_prompt + " For example, how could you respond to: Available moves: U, D, L"},
    ...
    for msg in messages:
        output.write("SYSTEM: " + msg['content'] + "\n")
    ...
    while running:
        ...
        while(error_msg != ""):
            ...
            move = get_user_input((error_msg if error_msg != "error" else "") + "What will your move be (use your thoughts)?")
            print(thought + '\n' + move)
